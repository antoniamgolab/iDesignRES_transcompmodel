...
financial_status_list = [
    Dict(
        ...
        "name" => "Middle class",
        "VoT" => 15,
        "monetary_budget_purchase" => 12000,
        "monetary_budget_purchase_lb" => 10000,
        "monetary_budget_purchase_ub" => 13000,
        "monetary_budget_purchase_time_horizon" => 6,
    ),
]
...
mode_list = [
    Dict(
        ...
        "costs_per_ukm" => fill(0.12, Y + 1),
        "emission_factor" => fill(263, Y + 1),
        "infrastructure_expansion_costs" => fill(0.1, Y + 1),
        "infrastructure_om_costs" => fill(0.2, Y + 1),
        "waiting_time" => fill(5, Y + 1),
    ),
    Dict(
        "id" => 2,
        "name" => "Rail",
        "quantify_by_vehs" => false,
        "costs_per_ukm" => fill(0.1, Y + 1),
        "emission_factor" => fill(0, Y + 1),
        "infrastructure_expansion_costs" => fill(0.1, Y + 1),
        "infrastructure_om_costs" => fill(0.2, Y + 1),
        "waiting_time" => fill(5, Y + 1),
    ),
...
path_list = [
    Dict(
        ...
        "name" => "1",
        "length" => 8,
        "sequence" => [geographic_element_list[1]["id"]],
    ),
]
...
fuel_list = [
    Dict(
        "id" => 1,
        "name" => "petrol",
        "emission_factor" => fill(5, Y + 1),
        "cost_per_kWh" => fill(10, Y + 1),
        "cost_per_kW" => fill(0, Y + 1),
        "fueling_infrastructure_om_costs" => fill(0.1, Y + 1),
    ),
    Dict(
        "id" => 2,
        "name" => "electricity",
        "emission_factor" => fill(4, Y + 1),
        "cost_per_kWh" => fill(350, Y + 1),
        "cost_per_kW" => fill(0, Y + 1),
        "fueling_infrastructure_om_costs" => fill(0.1, Y + 1),
    ),
]
...
techvehicle_list = [
    Dict(
        "id" => 1,
        "name" => "ICEV passenger car",
        "vehicle_type" => vehicle_type_list[1]["name"],
        "technology" => technology_list[1]["id"],
        "capital_cost" => fill(80000, Y + pre_y + 1),
        "maintenance_cost_annual" => fill(fill(10, Y + 1), Y + 1 + pre_y),
        "maintenance_cost_distance" => fill(fill(10, Y + 1), Y + 1 + pre_y),
        "W" => fill(1, Y + 1 + pre_y),
        "spec_cons" => fill(5, Y + 1 + pre_y),
        "Lifetime" => fill(2, Y + 1 + pre_y),
        "AnnualRange" => fill(10000, Y + pre_y + 1),
        "products" => [product_list[1]["name"]],
        "tank_capacity" => fill(100, Y + 1 + pre_y),
        "peak_fueling" => fill(30, Y + 1 + pre_y),
        "fueling_time" => fill(5 / 60, Y + 1 + pre_y),
    ),
    Dict(
        "id" => 2,
        "name" => "BEV passenger car",
        "vehicle_type" => vehicle_type_list[1]["name"],
        "technology" => technology_list[2]["id"],
        "capital_cost" => fill(60000, Y + pre_y + 1),
        "maintenance_cost_annual" => fill(fill(10, Y + 1), Y + 1 + pre_y),
        "maintenance_cost_distance" => fill(fill(10, Y + 1), Y + 1 + pre_y),
        "W" => fill(1, Y + 1 + pre_y),
        "spec_cons" => fill(5, Y + 1 + pre_y),
...
initvehiclestock_list = [
    Dict(
        "id" => 1,
        "techvehicle" => techvehicle_list[1]["id"],
        "year_of_purchase" => 2015,
        "stock" => total_vehs / pre_y,
    ),
    Dict(
        "id" => 2,
        "techvehicle" => techvehicle_list[1]["id"],
    ...
    Dict(
        "id" => 6,
        "techvehicle" => techvehicle_list[2]["id"],
        "year_of_purchase" => 2015,
        "stock" => 0,
    ),
    Dict(
...
initialmodeinfr_list = [
    Dict(
        "id" => 1,
        "mode" => mode_list[1]["id"],
        "allocation" => geographic_element_list[1]["id"],
        "installed_ukm" => 0,
    ),
    Dict(
        "id" => 2,
...
initialfuelinginfr_list = [
    Dict(
        "id" => 1,
        "fuel" => fuel_list[1]["name"],
        "allocation" => geographic_element_list[1]["id"],
        "installed_kW" => 0,
    ),
    Dict(
        "id" => 2,
        "fuel" => fuel_list[2]["name"],
        "allocation" => geographic_element_list[1]["id"],
        "installed_kW" => 0,
    ),
]
...
@testset "Input data reading" begin
    ...
    techvehicle_list_wrong = [
        Dict(
            ...
            "technology" => technology_list[1]["id"],
            "capital_cost" => fill(80000, Y + pre_y + 1),
            "maintenance_cost_annual" => fill(fill(10, Y + 1), Y + 1),
            "maintenance_cost_distance" => fill(fill(10, Y + 1), Y + 1 + pre_y),
            "W" => fill(1, Y + 1 + pre_y),
            "spec_cons" => fill(5, Y + 1 + pre_y),
            "Lifetime" => fill(2, Y + 1 + pre_y),
