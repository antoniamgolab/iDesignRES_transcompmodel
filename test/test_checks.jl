...
@testset "check_model_parametrization" begin
    d = Dict("Model" => Dict())
    @test_throws KeyError check_model_parametrization(d, ["missing_key"])
end
...
@testset "check_correct_formats_GeographicElement" begin
    ...
    @test_throws AssertionError check_correct_formats_GeographicElement(d, 1)
end
...
@testset "check_correct_formats_FinancialStatus" begin
    ...
    @test_throws AssertionError check_correct_formats_FinancialStatus(d)
end
...
@testset "check_correct_format_TechVehicle" begin
    ...
    @test_throws AssertionError check_correct_format_TechVehicle(d, 1, 1)
end
...
@testset "check_correct_format_InitialVehicleStock" begin
    ...
    @test_throws AssertionError check_correct_format_InitialVehicleStock(d, 1, 1)
end
...
@testset "check_correct_format_InitialFuelingInfr" begin
    ...
    @test_throws AssertionError check_correct_format_InitialFuelingInfr(d)
end
...
@testset "check_correct_format_InitialModeInfr" begin
    ...
    @test_throws AssertionError check_correct_format_InitialModeInfr(d)
end
