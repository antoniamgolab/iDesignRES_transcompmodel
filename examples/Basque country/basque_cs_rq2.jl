...
# constraint_fueling_infrastructure_expansion_shift(model, data_structures) # TODO: adapt this 
@info "Constraint for fueling infrastructure expansion and shift created successfully"
# constraint_q_fuel_abs(model, data_structures) # removed compared to rq1
