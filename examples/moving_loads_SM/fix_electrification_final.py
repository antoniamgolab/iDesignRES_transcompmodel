"""
Fix the electrification cell with the CORRECT key structure:
key = (year, tv_id_tuple, generation_tuple, odpair_id)
"""
...
# The corrected cell code with proper key interpretation
...
if len(df_electrification) == 0:
    ...
    print("  2. Check the diagnostic cell above to see available years")
    print("\\nTip: Adjust years_to_plot to match available years in your data")
    print("=" * 80)
else:
...
# Find the electrification cell (cell 34 based on previous output)
...
if target_cell_idx is None:
    ...
    print("\nCRITICAL FIX:")
    print("  OLD: key = (odpair_id, tv_id, g, y)")
    print("  NEW: key = (year, tv_id, g, odpair_id)")
    print("\nThe first element is the YEAR, not the odpair ID!")
    print("Now filtering by actual years (2024, 2034) instead of indices.")
